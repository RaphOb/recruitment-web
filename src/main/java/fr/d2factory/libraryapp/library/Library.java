...
public interface Library {
     ...
     * @see Member
     */
    Book borrowBook(long isbnCode, Member member, LocalDate borrowedAt) throws HasLateBooksException, IOException;
     ...
     */
    void returnBook(Book book, Member member) throws NoSuchFieldException, IOException;
}
